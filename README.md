...
```bash
cd ~/.openclaw
git clone https://github.com/apple-techie/mission-control.git
cd mission-control
./setup.sh
```
...
https://github.com/apple-techie/mission-control
```
...
Pull requests welcome. Found a bug or have an idea? [Open an issue](https://github.com/apple-techie/mission-control/issues).
